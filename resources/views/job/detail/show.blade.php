...
<div class="container">
  <div class="row">
    <div class="col s12">
      ...
      <div class="input-field col l6 s12">
        <input type="text" id="intervened_part" name="intervened_part" aria-describedby="intervened_part_help"
               value="{{$jobDetail['intervened_part']}}" disabled>
      ...
      <div class="input-field col l6 s12">
        <textarea id="intervention_description" name="intervention_description" class="materialize-textarea"
                  aria-describedby="intervention_description_help"
                  disabled>{{$jobDetail['intervention_description']}}</textarea>
      ...
      <div class="input-field col l6 s12">
        <input type="number" id="workforce_cost" name="workforce_cost" aria-describedby="workforce_cost_help"
               value="{{$jobDetail['workforce_cost']}}" disabled>
        <label for="workforce_cost">Costo de la mano de obra</label>
      </div>

      <div class="input-field col l6 s12">
        <input type="number" id="total_intervention" name="total_intervention" aria-describedby="total_intervention"
